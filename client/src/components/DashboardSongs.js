    ...
    <div className="w-full p-4 flex items-center justify-center flex-col">
      <div className="w-full flex justify-center items-center gap-24">
        <NavLink
          ...
          className="flex items-center px-4 py-3 bg-primary border rounded-md border-gray-300 hover:border-gray-400 hover:shadow-md cursor-pointer"
        >
          <IoAdd />
        </NavLink>
        <input
          ...
          className={`w-52 px-4 py-2 border  bg-primary ${
            isFocus ? "border-gray-500 shadow-md" : "border-gray-300"
          } rounded-md  outline-none duration-150 transition-all ease-in-out text-base text-textColor font-semibold`}
          value={songFilter}
