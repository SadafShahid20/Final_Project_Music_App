...
const Header = () => {
  ...
  return (
    <header className="flex items-center bg-black w-full p-4 md:py-2 md:px-6">
      <NavLink to={"/"}>
      ...
      >
        ...
        {isMenu && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 50 }}
            className="absolute z-10 top-12 right-0 w-275 p-4 gap-4 shadow-lg rounded-lg backdrop-blur-sm flex flex-col"
          >
